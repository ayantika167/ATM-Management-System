...
public class Login_check extends javax.swing.JFrame {

    /**
     * Creates new form Login_check
     */
    public Login_check() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Login_check.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Login_check().setVisible(true);
            }
        });
    }
